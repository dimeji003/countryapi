...
const australia = data.filter(country => country.continents == 'Australia')
const australiaCard = australia.map(country => (
  ...
  return (
    <div className='grid md:grid-cols-3 grid-cols-2 gap-5 w-[90%] py-11 m-auto'>{australiaCard}</div>
  )
}

...
const northamerica = data.filter(country => country.continents == 'North America')
const northamericaCard = northamerica.map(country => (
  ...
  return (
    <div className='grid md:grid-cols-3 grid-cols-2 gap-5 w-[90%] py-11 m-auto'>{northamericaCard}</div>
  )
}